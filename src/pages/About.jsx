        ...
        <>
            ...
            <main id="main-content" className="about-wrapper px-2.5 lg:px-10" aria-label="About page main content">
                ...
                <div className="flex flex-col lg:flex-row justify-between">
                    ...
                    <div className="flex-1 lg:order-2 lg:hidden">
                        <p className="tracking-wide impact-text uppercase text-[4.5rem] leading-[4rem] md:text-[8rem] md:leading-[7rem] lg:text-[9rem] lg:leading-[9rem] xl:text-[11rem] xl:leading-[10rem] font-bold text-right">
                            code<br />
                            devo<br />
                            build
                        </p>
                    ...
                    <article className="about-content pb-5 text-base md:text-xl flex-1 lg:text-[1.3rem] xl:text-[1.6rem] xl:pb-10">
                        ...
                        <div className="about-term" aria-label="Explanation of the concept Unspecialty">
                            <p className="font-lato text-[3rem] pb-1 font-extrabold md:text-[3rem] xl:mt-10">A Term about “unspecialty”</p>
