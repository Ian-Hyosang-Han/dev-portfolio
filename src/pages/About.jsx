    ...
    return (
        <div className="about-wrapper">
            ...
            <div className="about-term">
                <p className="font-rajdhani text-2xl px-2.5 py-5 font-bold">A Term about “unspecialty”</p>
                <p className="px-2.5 text-white font-lato mb-5 " >The word <strong>"Unspecialty"</strong> came to me during my time as a barista, while I was crafting coffee and beverages. At that time, it was important to meet people's expectations of a special drink or a specific taste. However, I realized that even without using particularly fancy beans or expensive ingredients, there was still plenty of specialness to be found in the process.
